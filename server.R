...
shinyServer(function(input, output, session) {
  consumer_api_key <- "7TwaLNrIj3vDEKtYd1TATXAR4" # Enter your consumer key
  consumer_api_secret <- "gBrY7mdh08N9AUubGzjxHOqPXmnXFQvIY3djVrHtNXmUcObGwQ" # Enter your consumer secret
  access_token <- "1220695170028621824-DcXY7wunEol7IAMieOGQxZBE31J4X7" # Enter your access token
  access_token_secret <- "a8ARMn5LH61jQjFo28pSBlUv2Q5gwZ6RzKmPh0QHXktXX" # Enter your access secret
  ...
  pos.words = scan('C:/Users/Kenn/Desktop/S.A. on 5G Conspiracy Theory/covid19SA/positive_words.txt', what='character', comment.char=';') #Provide your path to "positive_words.txt" file
  neg.words = scan('C:/Users/Kenn/Desktop/S.A. on 5G Conspiracy Theory/covid19SA/negative_words.txt', what='character', comment.char=';') #Provide your path to "negative_words.txt" file
